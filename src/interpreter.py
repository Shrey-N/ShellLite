...
class Interpreter:
    ...
    def visit_Call(self, node: Call):
        ...
        # func_def.args is List[tuple[str, Optional[Node]]]
        ...
        for i, (arg_name, default_node) in enumerate(func_def.args):
            if i < len(node.args):
    ...
    def visit_MethodCall(self, node: MethodCall):
        ...
        if not isinstance(instance, Instance):
            raise TypeError(f"'{node.instance_name}' is not a structure instance.")
