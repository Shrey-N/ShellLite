...
def run_benchmark():
    # Iteration counts
    # Iteration counts (Massive Scale)
    ...
    for n in counts:
        ...
        # 1. Interpreter (Only run for small N)
        ...
        try:
             # compile_and_run_jit returns (compile_time, run_time, result)
    ...
    # Save to Root for easier access
